...
from charles.data.sdp_data import data
from charles.selection import tournament_selection #,fps
from charles.mutation import food_combination_mutation
from charles.crossover import single_point_co
from random import randint, uniform, choice #,random
from charles.utils import plot_c
...
def get_fitness(self):
    ...
    for i, (nutrients, min_req) in enumerate(nutrients):
