...
class Individual:
    def __init__(self, representation=None):
        ...
        if representation is None:
            self.representation = [randint(0,10) for _ in range(58)]
        else:
        ...
        for _ in range(generations):
            ...
            while len(new_population) < len(pop):
                ...
                if uniform(0, 1) < mutation_rate:
                    offspring1 = mutate(individual=offspring1,elem_mute_rate=0.2)
                if uniform(0, 1) < mutation_rate:
                    offspring2 = mutate(individual=offspring2,elem_mute_rate=0.2)
