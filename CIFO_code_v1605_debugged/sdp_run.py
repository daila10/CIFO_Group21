...
from crossover import single_point_co, uniform_co, multi_point_co, arithmetic_co, cycle_xo, geometric_co, pmx
...
pop.evolve(pop=pop, generations=1000, select=ranking_selection,
           mutate=random_mutation, mutation_rate=0.2, crossover=single_point_co,
