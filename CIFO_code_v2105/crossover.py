...
def cycle_xo(p1, p2):
    ...
    start_index = 0
    while None in offspring1:
        if offspring1[start_index] is None:
            # copy the cycle elements
            val1 = p1[start_index]
            val2 = p2[start_index]

            while val1 != val2:
                offspring1[start_index] = p1[start_index]
                offspring2[start_index] = p2[start_index]

                try:
                    start_index = p1.index(val2)
                except ValueError:
                    break
        ...
        start_index = (start_index + 1) % len(p1)
