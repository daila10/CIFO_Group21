...
foods_order = ['beef', 'chicken', 'milk', 'cheese', 'grapes', 'melon', 'watermelon', 'tangerine', 'lemon', 'banana', 'pineapple', 'red apple', 'green apple', 'pear', 'peach',
'cherries', 'strawberry', 'kiwifruit','potato', 'tomato', 'avocado', 'eggplant', 'corn', 'hot pepper', 'cucumber', 'mushroom', 'carrot',
'peanuts', 'chestnut', 'bread', 'rice', 'spaghetti', 'bacon', 'hamburger', 'french fries',
'pizza', 'hotdog', 'taco', 'burrito', 'popcorn','croissant', 'french bread', 'pancakes', 'rice crackers', 'fried shrimp', 'ice cream', 'doughnut', 'cookie',
