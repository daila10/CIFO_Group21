...
crossover_operators = [arithmetic_co, geometric_co]
crossover_names = ['Arithmetic', 'Geometric']
...
# Combine fitness values for arithmetic and geometric crossover
...
# Calculate the mean fitness values for arithmetic and geometric crossover
...
# Calculate the minimum and maximum fitness values for arithmetic and geometric crossover
